 ...
 *
 * 카드에는 제목만 크게 싣는다 — 본문은 들어간 글에서만 보여준다.
 *
    ...
    <li>
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <h3 className="line-clamp-3 font-display text-[18px] font-bold leading-snug tracking-[-0.015em] text-fg transition-colors group-hover:text-brand">
            {post.title}
          </h3>
        </div>
